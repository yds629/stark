...
url = 'http://job.ustc.edu.cn/list.php?MenuID=002004'
front = 'http://job.ustc.edu.cn/'

post_data = {
    'Referer': "http://job.ustc.edu.cn/list.php?MenuID=002004", 
